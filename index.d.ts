...
export declare class API {
  ...
  get(...handler: HandlerFunction[] | Middleware[]): void;
  post(path: string, ...handler: HandlerFunction[] | Middleware[]): void;
  post(...handler: HandlerFunction[] | Middleware[]): void;
  put(path: string, ...handler: HandlerFunction[] | Middleware[]): void;
  put(...handler: HandlerFunction[] | Middleware[]): void;
  patch(path: string, ...handler: HandlerFunction[] | Middleware[]): void;
  patch(...handler: HandlerFunction[] | Middleware[]): void;
  delete(path: string, ...handler: HandlerFunction[] | Middleware[]): void;
  delete(...handler: HandlerFunction[] | Middleware[]): void;
  options(path: string, ...handler: HandlerFunction[] | Middleware[]): void;
  options(...handler: HandlerFunction[] | Middleware[]): void;
  head(path: string, ...handler: HandlerFunction[] | Middleware[]): void;
  head(...handler: HandlerFunction[] | Middleware[]): void;
  any(path: string, ...handler: HandlerFunction[] | Middleware[]): void;
  any(...handler: HandlerFunction[] | Middleware[]): void;
  METHOD(method: METHODS, path: string, ...handler: HandlerFunction[] | Middleware[]): void;
  METHOD(method: METHODS, ...handler: HandlerFunction[] | Middleware[]): void;
