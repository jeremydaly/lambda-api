...
describe('Route Tests:', function() {
  ...
  describe('GET', function() {
    ...
    it('Path with parameter: /test/123', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"get","status":"ok","param":"123","param2":"123"}', isBase64Encoded: false })
    }) // end it
    ...
    it('Path with parameter and querystring: /test/123/query/?test=321', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"get","status":"ok","param":"123","query":{"test":"321"},"multiValueQuery":{"test":["321"]}}', isBase64Encoded: false })
    }) // end it
    ...
    it('Path with parameter and multiple querystring: /test/123/query/?test=123&test=321', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"get","status":"ok","param":"123","query":{"test":"321"},"multiValueQuery":{"test":["123","321"]}}', isBase64Encoded: false })
    }) // end it
    ...
    it('Path with multiple parameters and querystring: /test/123/query/456/?test=321', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"get","status":"ok","params":{"test":"123","test2":"456"},"query":"321"}', isBase64Encoded: false })
    }) // end it
  ...
  describe('HEAD', function() {
    ...
    it('Missing path: /not_found', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 404, body: '', isBase64Encoded: false })
    }) // end it

    it('Override HEAD request', async function() {
      let _event = Object.assign({},event,{ path: '/override/head/request', httpMethod: 'head' })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'], 'method': ['head'] }, statusCode: 200, body: '', isBase64Encoded: false })
    }) // end it

    it('Wildcard HEAD request', async function() {
      let _event = Object.assign({},event,{ path: '/head/override', httpMethod: 'head' })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'], 'wildcard': [true] }, statusCode: 200, body: '', isBase64Encoded: false })
    }) // end it
  ...
  describe('POST', function() {
    ...
    it('Simple path: /test', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"post","status":"ok"}', isBase64Encoded: false })
    }) // end it
    ...
    it('Path with parameter: /test/123', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"post","status":"ok","param":"123"}', isBase64Encoded: false })
    }) // end it
    ...
    it('Path with parameter and querystring: /test/123/query/?test=321', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"post","status":"ok","param":"123","query":{"test":"321"},"multiValueQuery":{"test":["321"]}}', isBase64Encoded: false })
    }) // end it

    it('Path with parameter and multiple querystring: /test/123/query/?test=123&test=321', async function() {
      let _event = Object.assign({},event,{ path: '/test/123/query', httpMethod: 'post', multiValueQueryStringParameters: { test: ['123', '321'] } })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"post","status":"ok","param":"123","query":{"test":"321"},"multiValueQuery":{"test":["123","321"]}}', isBase64Encoded: false })
    }) // end it

    it('Path with multiple parameters and querystring: /test/123/query/456/?test=321', async function() {
      let _event = Object.assign({},event,{ path: '/test/123/query/456', httpMethod: 'post', queryStringParameters: { test: '321' } })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"post","status":"ok","params":{"test":"123","test2":"456"},"query":"321"}', isBase64Encoded: false })
    }) // end it

    it('With JSON body: /test/json', async function() {
      let _event = Object.assign({},event,{ path: '/test/json', httpMethod: 'post', body: { test: '123' } })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"post","status":"ok","body":{"test":"123"}}', isBase64Encoded: false })
    }) // end it
    ...
    it('With x-www-form-urlencoded body: /test/form', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"post","status":"ok","body":{"test":"123","test2":"456"}}', isBase64Encoded: false })
    }) // end it
    ...
    it('With base64 encoded body', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"post","status":"ok","body":"Test file for sendFile\\n"}', isBase64Encoded: false })
    }) // end it
    ...
    it('With base64 encoding flagged and no body', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"post","status":"ok","body":""}', isBase64Encoded: false })
    }) // end it
  ...
  describe('PUT', function() {
    ...
    it('Simple path: /test', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"put","status":"ok"}', isBase64Encoded: false })
    }) // end it
    ...
    it('Path with parameter: /test/123', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"put","status":"ok","param":"123"}', isBase64Encoded: false })
    }) // end it
    ...
    it('Path with parameter and querystring: /test/123/query/?test=321', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"put","status":"ok","param":"123","query":{"test":"321"},"multiValueQuery":{"test":["321"]}}', isBase64Encoded: false })
    }) // end it

    it('Path with parameter and multiple querystring: /test/123/query/?test=123&test=321', async function() {
      let _event = Object.assign({},event,{ path: '/test/123/query', httpMethod: 'put', multiValueQueryStringParameters: { test: ['123', '321'] } })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"put","status":"ok","param":"123","query":{"test":"321"},"multiValueQuery":{"test":["123","321"]}}', isBase64Encoded: false })
    }) // end it

    it('Path with multiple parameters and querystring: /test/123/query/456/?test=321', async function() {
      let _event = Object.assign({},event,{ path: '/test/123/query/456', httpMethod: 'put', queryStringParameters: { test: '321' } })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"put","status":"ok","params":{"test":"123","test2":"456"},"query":"321"}', isBase64Encoded: false })
    }) // end it
    ...
    it('With JSON body: /test/json', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"put","status":"ok","body":{"test":"123"}}', isBase64Encoded: false })
    }) // end it
    ...
    it('With x-www-form-urlencoded body: /test/form', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"put","status":"ok","body":{"test":"123","test2":"456"}}', isBase64Encoded: false })
    }) // end it
  ...
  describe('PATCH', function() {
    ...
    it('Simple path: /test', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"patch","status":"ok"}', isBase64Encoded: false })
    }) // end it

    it('Path with parameter: /test/123', async function() {
      let _event = Object.assign({},event,{ path: '/test/123', httpMethod: 'patch' })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"patch","status":"ok","param":"123"}', isBase64Encoded: false })
    }) // end it
    ...
    it('Path with multiple parameters: /test/123/456', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"patch","status":"ok","params":{"test":"123","test2":"456"}}', isBase64Encoded: false })
    }) // end it
  ...
  describe('DELETE', function() {
    ...
    it('Path with parameter: /test/123', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"delete","status":"ok","param":"123"}', isBase64Encoded: false })
    }) // end it

    it('Path with multiple parameters: /test/123/456', async function() {
      let _event = Object.assign({},event,{ path: '/test/123/456', httpMethod: 'delete' })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"delete","status":"ok","params":{"test":"123","test2":"456"}}', isBase64Encoded: false })
    }) // end it
  ...
  describe('OPTIONS', function() {
    ...
    it('Simple path: /test', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"options","status":"ok"}', isBase64Encoded: false })
    }) // end it
    ...
    it('Path with parameter: /test/123', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"options","status":"ok","param":"123"}', isBase64Encoded: false })
    }) // end it
    ...
    it('Path with parameter and querystring: /test/123/query/?test=321', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"options","status":"ok","param":"123","query":{"test":"321"},"multiValueQuery":{"test":["321"]}}', isBase64Encoded: false })
    }) // end it

    it('Path with parameter and multiple querystring: /test/123/query/?test=123&test=321', async function() {
      let _event = Object.assign({},event,{ path: '/test/123/query', httpMethod: 'options', multiValueQueryStringParameters: { test: ['123', '321'] } })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"options","status":"ok","param":"123","query":{"test":"321"},"multiValueQuery":{"test":["123","321"]}}', isBase64Encoded: false })
    }) // end it

    it('Path with multiple parameters and querystring: /test/123/query/456/?test=321', async function() {
      let _event = Object.assign({},event,{ path: '/test/123/query/456', httpMethod: 'options', queryStringParameters: { test: '321' } })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"options","status":"ok","params":{"test":"123","test2":"456"},"query":"321"}', isBase64Encoded: false })
    }) // end it

    it('Wildcard: /test_options', async function() {
      let _event = Object.assign({},event,{ path: '/test_options', httpMethod: 'options' })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"options","status":"ok","path":"/*"}', isBase64Encoded: false })
    }) // end it
    ...
    it('Wildcard with path: /test_options2/123', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"options","status":"ok","path":"/test_options2/*"}', isBase64Encoded: false })
    }) // end it
    ...
    it('Nested Wildcard with parameters: /test_options2/param1/test', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"options","status":"ok","path":"/test_options2/:param1/*","params":{"param1":"param1"}}', isBase64Encoded: false })
    }) // end it
  ...
  describe('ANY', function() {
    ...
    it('GET request on ANY route', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"GET","path":"/any","anyRoute":true}', isBase64Encoded: false })
    }) // end it

    it('POST request on ANY route', async function() {
      let _event = Object.assign({},event,{ path: '/any', httpMethod: 'post' })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"POST","path":"/any","anyRoute":true}', isBase64Encoded: false })
    }) // end it

    it('PUT request on ANY route', async function() {
      let _event = Object.assign({},event,{ path: '/any', httpMethod: 'put' })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"PUT","path":"/any","anyRoute":true}', isBase64Encoded: false })
    }) // end it

    it('DELETE request on ANY route', async function() {
      let _event = Object.assign({},event,{ path: '/any', httpMethod: 'delete' })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"DELETE","path":"/any","anyRoute":true}', isBase64Encoded: false })
    }) // end it

    it('PATCH request on ANY route', async function() {
      let _event = Object.assign({},event,{ path: '/any', httpMethod: 'patch' })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"PATCH","path":"/any","anyRoute":true}', isBase64Encoded: false })
    }) // end it
    ...
    it('GET request on ANY route: /any2', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"GET","path":"/any2","anyRoute":true}', isBase64Encoded: false })
    }) // end it

    it('POST request that overrides ANY route: /any2', async function() {
      let _event = Object.assign({},event,{ path: '/any2', httpMethod: 'post' })
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"POST","path":"/any2","anyRoute":false}', isBase64Encoded: false })
    }) // end it
    ...
    it('GET request on ANY wildcard route: /anywildcard', async function() {
      ...
      let result = await new Promise(r => api.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"GET","path":"/anywildcard","anyRoute":true}', isBase64Encoded: false })
    }) // end it
  ...
  describe('METHOD', function() {
    ...
    it('Default path', async function() {
      let _event = Object.assign({},event,{ path: '/test', httpMethod: 'post' })
      let result = await new Promise(r => api5.run(_event,{},(e,res) => { r(res) }))
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"method":"any","status":"ok"}', isBase64Encoded: false })
    }) // end it
  ...
  describe('Configuration errors', function() {
    ...
    it('Missing handler (w/ route)', async function() {
      ...
      expect(error.message).toBe('No handler or middleware specified for GET method on /test-missing-handler route.')
    }) // end it
    ...
    it('Missing handler', async function() {
      ...
      expect(error.name).toBe('ConfigurationError')
      expect(error.message).toBe('No handler or middleware specified for GET method on /* route.')
    }) // end it
    ...
    it('Invalid route-based middleware', async function() {
      ...
      expect(error.name).toBe('ConfigurationError')
      expect(error.message).toBe('Route-based middleware must have 3 parameters')
    }) // end it
    ...
    it('Invalid wildcard (mid-route)', async function() {
      ...
      expect(error.name).toBe('ConfigurationError')
      expect(error.message).toBe('Wildcards can only be at the end of a route definition')
    }) // end it
  ...
  describe('Route Method Inheritance', function() {
    ...
    it('Inherit multiple wildcard routes', async function() {
      ...
      expect(api6._response._request._stack.map(x => x.name)).toEqual([ 'anyWildcard', 'getWildcard', 'testHandler' ])
      expect(result).toEqual({ multiValueHeaders: { 'content-type': ['application/json'] }, statusCode: 200, body: '{"status":"ok"}', isBase64Encoded: false })
    }) // end it
